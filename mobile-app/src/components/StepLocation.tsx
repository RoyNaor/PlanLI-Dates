  ...
  return (
    <View>
      ...
      <View style={{ zIndex: 2000, marginBottom: 15 }}>
        ...
        <LocationSearch placeholder={t('stepLocation.yourAddress')} onLocationSelected={setL1} zIndex={2000} value={l1?.address} />
      </View>
      ...
      <View style={{ zIndex: 1000, marginBottom: 20 }}>
        ...
        <LocationSearch placeholder={t('stepLocation.theirAddress')} onLocationSelected={setL2} zIndex={1000} value={l2?.address} />
      </View>
